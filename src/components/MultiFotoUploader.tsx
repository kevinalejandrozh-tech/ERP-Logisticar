...
<div
key={i}
onClick={() => soloLectura && onVerFoto && onVerFoto(i)}
className={`relative w-14 h-14 rounded-md overflow-hidden border border-[var(--gray-200)] pointer-events-auto ${soloLectura ? "cursor-pointer" : ""}`}
>
